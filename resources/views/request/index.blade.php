                        ...
                        <div class="card-body px-4 py-3">
                            ...
                            <div class="col-9">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">All Requests</li>
                                </ol>
                                </nav>
                            </div>
                            <div class="col-3">
                                        ...
                                        @if($requests)
                                            ...
                                            <tr>
                                                ...
                                                <th class="justify-content-center">
                                                    <a href="{{ url('/request/process', $request->id) }}"> <i class="ti ti-edit"></i></a>
                                                    @if($request->status !=0)
                                                        <a href="{{ url('/download-certificate', $request->id) }}" > <i class="ti ti-download"></i></a>
                                                    @endif
                                                </th>
                                            </tr>
                                            @endforeach
